...
},{}],"node_modules/translate/translate.min.js":[function(require,module,exports) {
var define;
...
},{"node-fetch":"node_modules/node-fetch/browser.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
onload = function onload() {
  output.innerHTML = "Seu ID \xE9 ".concat((0, _uuid.v4)());
  _translate.default.engine = 'libre';
  _translate.default.from = 'en';
  _translate.default.to = 'pt';
  output2.innerHTML = "\n        <p> \n            <input type=\"text\" id=\"original\" />\n            <button id=\"traduzir\">Traduzir</button>\n        </p>\n        <p id=\"traduzida\"></p>\n    ";

  traduzir.onclick = function () {
    (0, _translate.default)(original.value).then(function (t) {
      return traduzida.innerHTML = t;
    });
  };
};
},{"uuid":"node_modules/uuid/dist/esm-browser/index.js","translate":"node_modules/translate/translate.min.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/postgrad.e31bb0bc.js.map